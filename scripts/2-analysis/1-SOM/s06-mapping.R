...
som2_prot_to_arch = readr::read_rds(here("data/som_files/som_selections/som2_selection_complex.rds"))
som1_anch_to_prot = readr::read_rds(here("data/som_files/som_selections/som1_nrc_30_iter_1.rds"))
...
#  (HOLEY) input data to prototype dictionary -- using now the "meaningful" imputations
hole_to_prot = readr::read_rds(here("data/02_holey_data_to_prototypes_MeaningfulImpute.rds"))
...
writeRaster(x = archetypes_map,
            filename = here("data/groundwater-PROBLEMSCAPES-with-mi2.tif"),
            overwrite = T)
# 
...
# #             filename = here("data/groundwater-RISK-archetypes_3x3_simple.tif"),
# #             overwrite = T)
# 
# writeRaster(x = archetypes_map_3x3,
#             filename = here("data/groundwater-RISK-TYPES-current-iter-3x3.tif"),
#             overwrite = T)
