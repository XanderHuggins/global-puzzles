...
df = readr::read_rds(here("data/som_files/som1_performance/som_performance_combined_syntheticspace.rds"))
...
write_rds(iter_index, file = here("data/som_files/input_data/01_full_SOM_iteration_sizing_index.rds"))
